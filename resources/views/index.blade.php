...
<head>
  <title>Antibacterial Sanitizer Shop - Home</title>
  <x-headerCss/> 
</head>
<body>
<x-Header menuName="home"/>  
        ...
        <div class="row align-left justify-content-center align-items-center">
            ...
            <div class="col-12 col-md-12 col-lg-6">
                <div class="text-wrapper">
                    ...
                    <div class="mbr-section-btn mt-3"><a class="btn btn-lg btn-white display-4" href="https://mobiri.se/"><span class="mobi-mbri mobi-mbri-arrow-next mbr-iconfont mbr-iconfont-btn"></span>Shop now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card-wrapper">
                    <div class="text-wrapper">
                        ...
                        <div class="mbr-section-btn"><a href="https://mobiri.se/" class="btn btn-md btn-primary display-4">More</a></div>

                    </div>
                    <div class="img-wrapper">
                        <img src="assets/images/card2.jpg" alt="Mobirise" title="">
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4">
                <div class="card-wrapper">
                    <div class="text-wrapper">
                        ...
                        <div class="mbr-section-btn"><a href="https://mobiri.se/" class="btn btn-md btn-primary display-4">Shop now</a></div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card-wrapper">
                    <div class="text-wrapper">
                        ...
                        <div class="mbr-section-btn"><a href="https://mobiri.se/" class="btn btn-md btn-primary display-4">Buy now</a></div>
                    </div>
                    <div class="img-wrapper">
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-2">
                <div class="item-wrapper">
                    ...
                    <h5 class="price mbr-fonts-style m-0 display-7">
                       ...
                       <img src="assets/images/mbr-1.jpg" data-slide-to="5" alt="" title="">
                    </div>
                ...
                <div class="item-wrapper">
                    ...
                    <h5 class="price mbr-fonts-style m-0 display-7">
                        ...
                        <img src="assets/images/mbr.jpg" data-slide-to="0" alt="" title="">
                    </div>
                    <div class="item-content">
                ...
                <div class="item-wrapper">
                    ...
                    <h5 class="price mbr-fonts-style m-0 display-7">
                        ...
                        <img src="assets/images/mbr-3.jpg" data-slide-to="1" alt="" title="">
                    </div>
                   <div class="item-content">
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        ...
                        <img src="assets/images/mbr-4.jpg" data-slide-to="2" alt="" title="">
                    </div>
                   <div class="item-content">
            ...
            <div class="item-wrapper">
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="text-wrapper">
                        ...
                        <div class="mbr-section-btn mt-3"><a class="btn btn-md btn-primary display-4" href="https://mobiri.se/">More</a></div>
                    </div>
                </div>
...
<!--Formbuilder Form-->
<form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="kSMI3GnuaWVZAJIvrtMuyt4AYWwoIAhbsB3hzcliE914LNzhA03qkBSoNo+n12iLYp8dJSpx02c3upNlxKp4z08rTXtZoeVobZmOjhxU7JebHg9+N7BtXVMMTB96KZz5">
<div class="form-row">
...
<input type="tel" name="phone" placeholder="Phone" data-form-field="phone" class="form-control display-7" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" value="" id="phone-form02-4">
</div>
...
<section class="map2 cid-snLXmEjTQd" id="map01-3">
    <div>
        <div class="google-map">
            <iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=place_id:ChIJn6wOs6lZwokRLKy1iqRcoKw" allowfullscreen=""></iframe>
        </div>
    </div>
</section>
